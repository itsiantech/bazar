            ...
            <div class="form-body">
                <div class="form-group">
                    ...
                    <div class="input-icon right">
                        <i class="fa fa-info-circle tooltips"   data-original-title="Category name in English" data-container="body"></i>
                         <input type="text" name="name_en" value="{{ $category->name_en }}" class="form-control"> </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon right">
                        ...
                        <input type="text" name="name_bn" value="{{ $category->name_bn }}" class="form-control"> </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon right">
                        <i class="fa fa-info-circle tooltips"   data-original-title="Category name in Bangla" data-container="body"></i>
                        <input type="text" name="slug" value="{{ $category->slug }}" class="form-control"> </div>
                    @if ($errors->has('slug'))
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon right">
                         ...
                         @foreach($categories as $parent)
                                <option @if($parent->id==$category->parent_id) selected @endif value="{{ $parent->id }}">{{ $parent->name_en }}</option>
                             @endforeach
                         </select>
