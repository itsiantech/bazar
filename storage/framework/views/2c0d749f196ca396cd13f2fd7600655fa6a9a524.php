...
<div class="portlet box green-seagreen">
    ...
    <div class="portlet-body">
        <form role="form" action="<?php echo e(route('deliveryCharge.update',['id'=>$deliveryCharge->id])); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div id="messageDiv">
            ...
            <div class="form-body">
                <div class="form-group">
                    ...
                    <div class="input-icon right">
                        ...
                        <input type="number" name="charge_amount" value="<?php echo e($deliveryCharge->charge_amount); ?>" class="form-control"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon right">
                        <i class="fa fa-info-circle tooltips" data-original-title="minimum amount"
                           data-container="body"></i>
                        <input type="number" name="minimum_amount" value="<?php echo e($deliveryCharge->minimum_amount); ?>" class="form-control"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon right">
                        <i class="fa fa-info-circle tooltips" data-original-title="maximum amount"
                           data-container="body"></i>
                        <input type="number" name="maximum_amount" value="<?php echo e($deliveryCharge->maximum_amount); ?>" class="form-control"></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\asiful\Desktop\laravel\bazar\resources\views/admin/delivery_charges/edit.blade.php ENDPATH**/ ?>