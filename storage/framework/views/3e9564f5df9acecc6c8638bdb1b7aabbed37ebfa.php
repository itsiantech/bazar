...
<div class="portlet box green-seagreen">
    ...
    <div class="portlet-body">
        <form role="form" action="<?php echo e(route('brand.update',['id'=>$brand->id])); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div id="messageDiv">
            ...
            <div class="form-body">
                <div class="form-group">
                    ...
                    <div class="input-icon right">
                        <i class="fa fa-info-circle tooltips"   data-original-title="Category name in English" data-container="body"></i>
                         <input type="text" name="name" value="<?php echo e($brand->name); ?>" class="form-control"> </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon right">
                        ...
                        <input type="text" name="slug" value="<?php echo e($brand->slug); ?>" class="form-control"> </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon right">
                        <i class="fa fa-info-circle tooltips"   data-original-title="Brand logo" data-container="body"></i>
                        <input type="file"class="form-control" onchange="loadFile(event)"
                               id="logo" name="logo"> </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\asiful\Desktop\laravel\bazar\resources\views/admin/brands/edit.blade.php ENDPATH**/ ?>