...
<?php $__env->startSection('content'); ?>
    ...
    <div class="portlet box green-seagreen">
        ...
        <div class="portlet-body">
            ...
            <form role="form" action="<?php echo e(route('product.update',['id'=>$product->id])); ?>" method="post" enctype="multipart/form-data">
            <!-- <form role="form" action="<?php echo e(route('product.update',['id'=>$product->id])); ?>" method="post" enctype="multipart/form-data"> -->
                <?php echo csrf_field(); ?>
                <div id="messageDiv1">
                ...
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="input-icon right">
                            ...
                            <input type="text" name="name_en" value="<?php echo e($product->name_en); ?>" class="form-control"> </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-icon right">
                            ...
                            <input type="text" name="name_bn" value="<?php echo e($product->name_bn); ?>" class="form-control"> </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-icon right">
                            ...
                            <input type="text" name="slug" value="<?php echo e($product->slug); ?>" required class="form-control"></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-icon right">
                            <i class="fa fa-info-circle tooltips"   data-original-title="Product name in English" data-container="body"></i>
                            <textarea rows="10" class="form-control" name="description_en"><?php echo e($product->description_en); ?></textarea>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-icon right">
                            <i class="fa fa-info-circle tooltips"   data-original-title="Product name in Bangla" data-container="body"></i>
                            <textarea rows="10" class="form-control" name="description_bn"><?php echo e($product->description_bn); ?></textarea>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-icon right">
                                ...
                                <input type="number" class="form-control" value="<?php echo e($product->price_en); ?>" name="price_en">
                            </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-icon right">
                                ...
                                <input type="text" value="<?php echo e($product->price_bn); ?>" class="form-control" name="price_bn">
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-icon right">
                                <i class="fa fa-info-circle tooltips"   data-original-title="Vat percent" data-container="body"></i>
                                <input type="number" class="form-control" step="0.01" name="attribute" value="<?php echo e($product->attribute); ?>">
                            </div>
                            <?php if($errors->has('quantity')): ?>
                                <span class="text-danger"><?php echo e($errors->first('quantity')); ?></span>
                            <?php endif; ?>
                    ...
                    <div class="row">
                        <div class="form-group col-md-3">
                            ...
                            <div class="input-icon right">
                                <i class="fa fa-info-circle tooltips"   data-original-title="Vat percent" data-container="body"></i>
                                <input type="number" value="<?php echo e($product->vat_percent); ?>" class="form-control" name="vat_percent">
                            </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="input-icon right">
                                <i class="fa fa-info-circle tooltips"   data-original-title="Tax percent" data-container="body"></i>
                                <input type="number" value="<?php echo e($product->sold_amount); ?>" class="form-control" name="sold_amount">
                            </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="input-icon right">
                                <input type="checkbox" <?php if($product->is_sold_out==1): ?>checked <?php endif; ?>  name="is_sold_out" class="form-control">
                            </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="input-icon right">
                                ...
                                <input type="number" value="<?php echo e($product->discount); ?>" class="form-control" name="discount">
                            </div>
                                ...
                                <div class="input-icon right">
                                    <select class="form-control" name="category_id">
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php if($category->id==$product->category_id): ?> selected <?php endif; ?> value="<?php echo e($category->id); ?>"><?php echo e($category->name_en); ?></option>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-6 col-md-6">
                            ...
                            <p><img src="<?php echo e(asset($product->featured_image)); ?>" id="output" width="200"/></p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\asiful\Desktop\laravel\bazar\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>