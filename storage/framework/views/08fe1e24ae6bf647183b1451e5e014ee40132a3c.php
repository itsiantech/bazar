                            ...
                            <?php $__currentLoopData = $topTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$topType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo e(route('topProduct.edit',['id'=>$topType->id])); ?>" class="btn btn-xs label label-sm label-success ">Update</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\asiful\Desktop\laravel\bazar\resources\views/admin/top_products/index.blade.php ENDPATH**/ ?>