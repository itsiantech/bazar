...
<div class="portlet box green-seagreen">
    ...
    <div class="portlet-body">
        <form role="form" action="<?php echo e(route('category.update',['id'=>$category->id])); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div id="messageDiv">
            ...
            <div class="form-body">
                <div class="form-group">
                    ...
                    <div class="input-icon right">
                        <i class="fa fa-info-circle tooltips"   data-original-title="Category name in English" data-container="body"></i>
                         <input type="text" name="name_en" value="<?php echo e($category->name_en); ?>" class="form-control"> </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon right">
                        ...
                        <input type="text" name="name_bn" value="<?php echo e($category->name_bn); ?>" class="form-control"> </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon right">
                        <i class="fa fa-info-circle tooltips"   data-original-title="Category name in Bangla" data-container="body"></i>
                        <input type="text" name="slug" value="<?php echo e($category->slug); ?>" class="form-control"> </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon right">
                         ...
                         <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php if($parent->id==$category->parent_id): ?> selected <?php endif; ?> value="<?php echo e($parent->id); ?>"><?php echo e($parent->name_en); ?></option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\asiful\Desktop\laravel\bazar\resources\views/admin/categories/edit.blade.php ENDPATH**/ ?>