...
<?php $__env->startSection('content'); ?>
    ...
    <div class="portlet box green-seagreen">
        ...
        <div class="portlet-body">
            <form role="form" action="<?php echo e(route('slider.update',['id'=>$slider->id])); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div id="messageDiv">
                ...
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="input-icon right">
                            ...
                            <input type="text" name="title" value="<?php echo e($slider->title); ?>" class="form-control"></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\asiful\Desktop\laravel\bazar\resources\views/admin/sliders/edit.blade.php ENDPATH**/ ?>